...
// 							下面是是对全局变量keyvalue数组http_versions、http_methods、http_status、http_status_body的操作
...
//从用户指定的keyvalue数组中获取按key（k）寻找对应的value
...
//从用户指定的keyvalue数组中获取按value（s）寻找对应的key
...
//创建并初始化keyvalue_buffer类型的keyvalue数组kvb
...
//将用户指定的key－value添加到keyvalue_buffer类型的keyvalue数组kvb的尾部
...
//释放keyvalue_buffer类型的keyvalue数组kvb
...
//创建并初始化s_keyvalue_buffer类型的s_keyvalue数组kvb
...
//将用户指定的key－value添加到s_keyvalue_buffer类型的s_keyvalue数组kvb的尾部
...
//释放s_keyvalue_buffer类型的s_keyvalue数组kvb
...
//创建并初始化httpauth_keyvalue_buffer类型的httpauth_keyvalue数组kvb
...
//将用户指定的key－realm-type添加到httpauth_keyvalue_buffer类型的httpauth_keyvalue数组kvb的尾部
...
//释放httpauth_keyvalue_buffer类型的httpauth_keyvalue数组kvb
...
//从各类型的keyvalue数组中获取按key（value）寻找对应的value（key）
...
//创建并初始化pcre_keyvalue_buffer类型的pcre_keyvalue数组kvb
...
//将用户指定的key－value添加到pcre_keyvalue_buffer类型的pcre_keyvalue数组kvb的尾部
...
//释放pcre_keyvalue_buffer类型的pcre_keyvalue数组kvb
